	   ...
	   System.out.print("This is before Test");
	     ...
	     /* System.out.print("This is before Test");
		  ...
		  public void shots() throws IOException {
			  ...
			  FileHandler.copy(cap, new File("C:\\Users\\fiza_\\eclipse-workspace\\TestNGPR1\\Screenshots\\1.png"));

		  }
		  public void shots_withargs(String name) throws IOException {
			  File cap=  ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
			  FileHandler.copy(cap, new File("C:\\Users\\fiza_\\eclipse-workspace\\TestNGPR1\\Screenshots\\"+name+".png"));
		  }
		  ...
		  public void shots_withdate() throws IOException {
			  ...
			  File cap=  ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
			  FileHandler.copy(cap, new File("C:\\Users\\fiza_\\eclipse-workspace\\TestNGPR1\\Screenshots\\"+name_dt+".png"));
		}
